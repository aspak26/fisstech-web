...
**Çalışma alanı kuralı:** `fisleapp` klasörü (mobil uygulama) artık AI asistanlar tarafından düzenlenebilir. Terminal komutları çalıştırılabilir, dosyalar değiştirilebilir.
